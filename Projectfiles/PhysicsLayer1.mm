...
@interface PhysicsLayer1 (PrivateMethods)
...
//            }
            case LEAP_GESTURE_TYPE_SCREEN_TAP: {
                ...
                [self addNewSpriteAt:ccp(2*screenTapGesture.position.x+1440/2, 2*screenTapGesture.position.y)];
